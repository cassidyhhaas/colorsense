...
[`palette/usage.py`](https://github.com/cassidyhhaas/colorsense/blob/main/src/colorsense/palette/usage.py) (`MIN_SHARE`, `MIN_MASS`, `ROLE_COMPONENTS`, `PROMINENCE_AREA_WEIGHT`),
